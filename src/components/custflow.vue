  ...
  <div class="packageDetails">
        ...
        <div class="custnormal">
            <div class="card-info-wrapper">
              ...
              <p class="p clearfix">
                <span class="pull-left">请选择套餐数</span>
                <span class="pull-right">
                  <div class="select-wrapper">
                    <span class="pull-left">叠加数:</span>
                    <select class="cardDays pull-right" v-model="days">
                      <option v-for="item in daysFn" :value="item">{{item}}</option>
                    </select>
                  </div>
                </span>
              </p>
              <p class="p clearfix">
                <span class="pull-left">套餐流量</span>
                <span class="pull-right">{{unitPrice*days*10/10}} </span>
              </p>
            </div>
          </div>
